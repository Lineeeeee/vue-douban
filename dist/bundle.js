...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(2), __webpack_require__(7), __webpack_require__(30).setImmediate))
...
exports.default = {
  ...
  created: function created() {
    ...
    this.$axios.get('https://node-douban-api.herokuapp.com/movie/in_theaters?start=' + start + '&count=' + count).then(function (res) {
      _this.title = res.data.title;
      _this.moviesList = res.data.subjects;
    });

    this.$axios.get('https://node-douban-api.herokuapp.com/movie/coming_soon?start=' + start + '&count=' + count).then(function (res) {
      _this.title_one = res.data.title;
      _this.moviesList_one = res.data.subjects;
    });
  },

  methods: {
    toList: function toList(text) {
...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    var start = this.$store.getters.getStart;
    var count = this.$store.getters.getCount;
    this.$axios.get(this.text + start + '&count=' + count).then(function (res) {
      _this.title = res.data.title;
      _this.moviesList = res.data.subjects;
      _this.$store.commit('updateStart', res.data.start + count);
    });
  },
  ...
  methods: {
    ...
    loadMore: function loadMore() {
      ...
      var count = this.$store.getters.getCount;
      setTimeout(function () {
        _this2.$axios.get(_this2.text + start + '&count=' + count).then(function (res) {
          _this2.moviesList = _this2.moviesList.concat(res.data.subjects);
          _this2.$store.commit('updateStart', res.data.start + count);
        });
        Indicator.close();
      }, 2000);
    }
...
exports.default = {
  ...
  computed: {
    getMeta: function getMeta() {
      var cast = this.movie.casts.reduce(function (name, value) {
    ...
    getOriginalTitle: function getOriginalTitle() {
  ...
  mounted: function mounted() {
    ...
    this.$axios.get('https://node-douban-api.herokuapp.com/movie/subject/' + id).then(function (res) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_61dd7a3d_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Header_vue__ = __webpack_require__(79);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_61dd7a3d_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Header_vue__["a" /* default */],
...
exports.default = {
  ...
  methods: {
    toSearch: function toSearch(text) {
...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    var start = this.$store.getters.getStart;
    this.$axios.get('https://node-douban-api.herokuapp.com/movie/search?q=' + this.text + '&start=' + start).then(function (res) {
      _this.title = res.data.title;
      _this.moviesList = res.data.subjects;
      _this.$store.commit('updateStart', start + res.data.count);
    });
  },
  ...
  methods: {
    loadMore: function loadMore() {
      ...
      var start = this.$store.getters.getStart;
      setTimeout(function () {
        _this2.$axios.get('https://node-douban-api.herokuapp.com/movie/search?q=' + _this2.text + '&start=' + start).then(function (res) {
          _this2.moviesList = _this2.moviesList.concat(res.data.subjects);
          _this2.$store.commit('updateStart', start + res.data.count);
        });
        Indicator.close();
      }, 2000);
    }
...
var _indicator = __webpack_require__(29);

var _indicator2 = _interopRequireDefault(_indicator);

var _style5 = __webpack_require__(35);

var _style6 = _interopRequireDefault(_style5);

var _infiniteScroll = __webpack_require__(37);
...
var store = new _vuex2.default.Store({
  ...
  mutations: {
    updateStart: function updateStart(state, num) {
      state.start = num;
    },
...
window.Indicator = _indicator2.default;
...
var _Movies = __webpack_require__(65);

var _Movies2 = _interopRequireDefault(_Movies);

var _MovieList = __webpack_require__(70);

var _MovieList2 = _interopRequireDefault(_MovieList);

var _MovieDetail = __webpack_require__(74);

var _MovieDetail2 = _interopRequireDefault(_MovieDetail);

var _SearchList = __webpack_require__(81);
...
var router = new _vueRouter2.default({
  routes: [//配置路由规则
  { path: '/', redirect: '/movies' }, { path: '/movies', name: 'movies', component: _Movies2.default }, { path: '/movies/list/:text', name: 'list', component: _MovieList2.default }, { path: '/movies/detail/:id', name: 'detail', component: _MovieDetail2.default }, { path: '/movies/search/:text', name: 'search', component: _SearchList2.default }]
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movies_vue__ = __webpack_require__(15);
...
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movies_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movies_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7ffef3f3_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Movies_vue__ = __webpack_require__(69);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-7ffef3f3"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7ffef3f3_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Movies_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/Movies.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7ffef3f3", Component.options)
  } else {
    hotAPI.reload("data-v-7ffef3f3", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("158a42f8", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7ffef3f3\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Movies.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7ffef3f3\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Movies.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.clearFix[data-v-7ffef3f3]::before,\n.clearFix[data-v-7ffef3f3]::after {\n  content: \"\";\n  display: block;\n  visibility: hidden;\n  height: 0;\n  line-height: 0;\n  clear: both;\n}\n.movies[data-v-7ffef3f3] {\n  background-color: #eee;\n}\n.movies h5[data-v-7ffef3f3] {\n  padding: 20px 22px;\n  margin: 0;\n  background-color: #eee;\n}\n.movies h5 .more[data-v-7ffef3f3] {\n  float: right;\n}\n.movies h5 .more a[data-v-7ffef3f3] {\n  color: #999;\n}\n.movies ul[data-v-7ffef3f3] {\n  list-style: none;\n  margin: 0 15px;\n  background-color: #fff;\n  border-radius: 10px;\n  padding-left: 0;\n  overflow: hidden;\n}\n.movies ul li[data-v-7ffef3f3] {\n  padding: 15px 15px;\n  text-align: center;\n  float: left;\n}\n.movies ul li a[data-v-7ffef3f3] {\n  display: block;\n  width: 98px;\n  height: 160.4px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.movies ul li a img[data-v-7ffef3f3] {\n  width: 100%;\n  height: 137px;\n}\n.movies ul li a h3[data-v-7ffef3f3] {\n  font-size: 15px;\n  font-weight: 400;\n  color: #494949;\n  text-overflow: ellipsis;\n  overflow: hidden;\n  display: -webkit-box;\n  -webkit-line-clamp: 1;\n  -webkit-box-orient: vertical;\n}\n", ""]);
...
var render = function() {
  ...
  return _vm.moviesList.length > 0
    ? _c("div", { staticClass: "movies" }, [
        _c("div", [
          _c("h5", [
            _vm._v("\n   " + _vm._s(this.title) + "\n   "),
          ...
          _c(
            "ul",
            _vm._l(_vm.moviesList, function(item, id) {
              return _c(
                "li",
                { key: id },
                [
                  _c(
                    ...
                    [
                      _c("img", { attrs: { src: item.images.large, alt: "" } }),
                      _vm._v(" "),
        ...
        _c("div", [
          ...
          _c(
            "ul",
            _vm._l(_vm.moviesList_one, function(item, id) {
              return _c("li", { key: id }, [
                _c("a", { attrs: { href: "#" } }, [
                  _c("img", { attrs: { src: item.images.large, alt: "" } }),
                  _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7ffef3f3", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_list_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_list_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_list_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_list_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_list_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ab60b46a_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Movie_list_vue__ = __webpack_require__(73);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-ab60b46a"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_list_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ab60b46a_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Movie_list_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/Movie-list.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ab60b46a", Component.options)
  } else {
    hotAPI.reload("data-v-ab60b46a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("2ce4aa04", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ab60b46a\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Movie-list.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ab60b46a\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Movie-list.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.movies[data-v-ab60b46a] {\n  background-color: #eee;\n}\n.movies h5[data-v-ab60b46a] {\n  padding: 20px 22px;\n  margin: 0;\n  background-color: #eee;\n}\n.movies h5 .more[data-v-ab60b46a] {\n  float: right;\n}\n.movies ul[data-v-ab60b46a] {\n  list-style: none;\n  margin: 0 15px;\n  background-color: #fff;\n  border-radius: 10px;\n  padding-left: 0;\n  overflow: hidden;\n}\n.movies ul li[data-v-ab60b46a] {\n  padding: 15px 15px;\n  text-align: center;\n  float: left;\n}\n.movies ul li a[data-v-ab60b46a] {\n  display: block;\n  width: 98px;\n  height: 160.4px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.movies ul li a img[data-v-ab60b46a] {\n  width: 100%;\n  height: 137px;\n}\n.movies ul li a h3[data-v-ab60b46a] {\n  font-size: 15px;\n  font-weight: 400;\n  color: #494949;\n  text-overflow: ellipsis;\n  overflow: hidden;\n  display: -webkit-box;\n  -webkit-line-clamp: 1;\n  -webkit-box-orient: vertical;\n}\n", ""]);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ab60b46a", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_detail_vue__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_detail_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_detail_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_detail_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_detail_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_406beabe_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Movie_detail_vue__ = __webpack_require__(80);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__(75)
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-406beabe"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Movie_detail_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_406beabe_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Movie_detail_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/Movie-detail.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-406beabe", Component.options)
  } else {
    hotAPI.reload("data-v-406beabe", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("22001bdb", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-406beabe\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Movie-detail.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-406beabe\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Movie-detail.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.detail[data-v-406beabe] {\n  background-color: #fff;\n  margin-top: 10px;\n  padding: 0 10px;\n  border-radius: 10px;\n}\n.detail h3[data-v-406beabe] {\n  padding-top: 10px;\n  font-size: 16px;\n  line-height: 32px;\n}\n.detail .pic[data-v-406beabe] {\n  padding-bottom: 15px;\n}\n.detail .pic img[data-v-406beabe] {\n  width: 100%;\n}\n.detail .pic p[data-v-406beabe] {\n  padding: 20px 0;\n  font-size: 16px;\n  color: #000;\n}\n.detail .pic div a[data-v-406beabe] {\n  border-radius: 3px;\n  border: 1px solid #ffb712;\n  color: #ffb712;\n  text-align: center;\n  font-size: 15px;\n  padding: 8px 0;\n  line-height: 34px;\n}\n.detail .pic div a.left[data-v-406beabe] {\n  padding: 8px 50px;\n}\n.detail .pic div a.right[data-v-406beabe] {\n  margin-left: 20px;\n  padding: 8px 70px;\n}\n.detail .main p[data-v-406beabe] {\n  text-indent: 2em;\n  line-height: 30px;\n  font-size: 16px;\n  margin-bottom: 0px;\n}\n", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("7b36b42a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-61dd7a3d\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Header.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-61dd7a3d\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Header.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.header[data-v-61dd7a3d] {\n  position: relative;\n}\n.header b[data-v-61dd7a3d] {\n  font-size: 13px;\n}\n.header .inp[data-v-61dd7a3d] {\n  text-align: left;\n  background-color: #fff;\n  margin-bottom: 0;\n}\n.header .search[data-v-61dd7a3d] {\n  position: absolute;\n  right: 6px;\n  top: 2px;\n  color: #ccc;\n  width: 30px;\n  height: 30px;\n  text-align: center;\n  line-height: 30px;\n  font-size: 30px;\n}\n", ""]);
...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "header" },
    [
      _c("mt-header", { attrs: { fixed: "", title: "vue-豆瓣app" } }, [
        _vm.active
          ? _c(
              "span",
              {
              ...
              [_c("b", { attrs: { icon: "back" } }, [_vm._v("< 返回")])]
            )
          : _vm._e()
      ]),
      _vm._v(" "),
      _c("input", {
        ...
        staticClass: "inp",
        attrs: { type: "search", placeholder: "请输入电影名称" },
      ...
      _vm._v(" "),
      _c("span", {
        staticClass: "mui-icon mui-icon-search search",
        on: {
          click: function($event) {
            _vm.toSearch(_vm.text)
          }
        }
      })
    ],
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.movie.title
    ? _c("div", { staticClass: "detail" }, [
        _c("h3", [
          _vm._v(_vm._s(_vm.movie.title) + " " + _vm._s(_vm.getOriginalTitle))
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "pic" }, [
          _c("img", { attrs: { src: _vm.movie.images.large, alt: "" } }),
          _vm._v(" "),
          _c("p", [_vm._v(_vm._s(_vm.getMeta))]),
          _vm._v(" "),
          _c("div", [
            _c("a", { staticClass: "left", attrs: { href: "#" } }, [
              _vm._v("想看(" + _vm._s(_vm.movie.wish_count) + ")")
            ]),
            _vm._v(" "),
        ...
        _c("div", { staticClass: "main" }, [
          _c("h3", [_vm._v(_vm._s(_vm.movie.title) + "的剧情介绍")]),
          _vm._v(" "),
          _c("p", [_vm._v("\n       " + _vm._s(_vm.movie.summary) + "\n     ")])
        ])
      ])
    : _vm._e()
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-406beabe", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Search_list_vue__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Search_list_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Search_list_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Search_list_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Search_list_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6b956a23_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Search_list_vue__ = __webpack_require__(84);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6b956a23"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Search_list_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6b956a23_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Search_list_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/Search-list.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6b956a23", Component.options)
  } else {
    hotAPI.reload("data-v-6b956a23", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("5f9fef0a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6b956a23\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Search-list.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6b956a23\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Search-list.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.movies[data-v-6b956a23] {\n  background-color: #eee;\n}\n.movies h5[data-v-6b956a23] {\n  padding: 20px 22px;\n  margin: 0;\n  background-color: #eee;\n}\n.movies h5 .more[data-v-6b956a23] {\n  float: right;\n}\n.movies ul[data-v-6b956a23] {\n  list-style: none;\n  margin: 0 15px;\n  background-color: #fff;\n  border-radius: 10px;\n  padding-left: 0;\n  overflow: hidden;\n}\n.movies ul li[data-v-6b956a23] {\n  padding: 15px 15px;\n  text-align: center;\n  float: left;\n}\n.movies ul li a[data-v-6b956a23] {\n  display: block;\n  width: 98px;\n  height: 160.4px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.movies ul li a img[data-v-6b956a23] {\n  width: 100%;\n  height: 137px;\n}\n.movies ul li a h3[data-v-6b956a23] {\n  font-size: 15px;\n  font-weight: 400;\n  color: #494949;\n  text-overflow: ellipsis;\n  overflow: hidden;\n  display: -webkit-box;\n  -webkit-line-clamp: 1;\n  -webkit-box-orient: vertical;\n}\n", ""]);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6b956a23", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7ba5bd90_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(88);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("ab8607c8", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
